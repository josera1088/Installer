...
namespace AMSInstaller
{
    class Installer
    {
        ...
        public Installer(string destinationPath, string dataSource, string databaseName, string username, string password, ModelPorts ports)
        {
        ...
        public static bool DeleteIISAPI(string module)
        {
            try
            {
                ...
                {
                    Site siteToRemove = iisManager.Sites[module];
        ...
        public bool InstallSc(string module, string executableName, string folderName)
        {
            ...
            try
            {
                ...
                string servicePath = System.IO.Path.Combine(Application.StartupPath, $@"{module}.zip");
        ...
        public void ValidateInitConfig(string dataSource, string dBName, string dBUsername, string password, bool test, MainForm main, ModelPorts ports)
        {
